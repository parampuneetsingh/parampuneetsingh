...
//Hard Problem
public class FindMedianTwoSortedArrays_4 {

	// Solved in O(log min(x,y))
	...
	public static void main(String[] args) {
		FindMedianTwoSortedArrays_4 median = new FindMedianTwoSortedArrays_4();
		int[] x = { 1, 3, 8, 9, 15 };
		int[] y = { 7, 11, 19, 21, 18, 25 };
		double res = median.findMedianSortedArrays(x, y);
